...
# instance fields
.field public A00:Lcom/instagram/api/schemas/ListeningNowResponseInfoIntf;

.field public A01:Lcom/instagram/api/schemas/MusicNoteResponseInfoIntf;

.field public A02:Lcom/instagram/api/schemas/OriginalAudioNoteResponseInfo;
...
.method public final synthetic AEo(Ljava/lang/String;I)LX/27n;
    ...
    invoke-virtual {p0, v0}, LX/2f4;->GYa(LX/2eo;)Lcom/facebook/pando/TreeUpdaterJNI;
...
.method public final synthetic AWx()LX/2k9;
    .locals 1
...
.method public final Boq()Lcom/instagram/api/schemas/GIFNoteResponseInfo;
    ...
    const-class v0, Lcom/instagram/api/schemas/ImmutablePandoGIFNoteResponseInfo;

    invoke-virtual {p0, v1, v0}, LX/I9I;->A1b(ILjava/lang/Class;)Lcom/facebook/pando/TreeJNI;

    move-result-object v0

    check-cast v0, Lcom/instagram/api/schemas/GIFNoteResponseInfo;
...
.method public final But()Lcom/instagram/api/schemas/HyperlinkNoteResponseInfo;
    ...
    const-class v0, Lcom/instagram/api/schemas/ImmutablePandoHyperlinkNoteResponseInfo;

    invoke-virtual {p0, v1, v0}, LX/I9I;->A1b(ILjava/lang/Class;)Lcom/facebook/pando/TreeJNI;

    move-result-object v0

    check-cast v0, Lcom/instagram/api/schemas/HyperlinkNoteResponseInfo;
...
.method public final C3E()Lcom/instagram/api/schemas/KnowledgeGraphNoteResponseInfo;
    ...
    const-class v0, Lcom/instagram/api/schemas/ImmutablePandoKnowledgeGraphNoteResponseInfo;

    invoke-virtual {p0, v1, v0}, LX/I9I;->A1b(ILjava/lang/Class;)Lcom/facebook/pando/TreeJNI;

    move-result-object v0

    check-cast v0, Lcom/instagram/api/schemas/KnowledgeGraphNoteResponseInfo;
...
.method public final C6l()Lcom/instagram/api/schemas/ListeningNowResponseInfoIntf;
    ...
    iget-object v0, p0, LX/2f4;->A00:Lcom/instagram/api/schemas/ListeningNowResponseInfoIntf;
    ...
    check-cast v0, Lcom/instagram/api/schemas/ListeningNowResponseInfoIntf;
...
.method public final C7Z()Lcom/instagram/api/schemas/LocationNoteResponseInfo;
    ...
    const-class v0, Lcom/instagram/api/schemas/ImmutablePandoLocationNoteResponseInfo;

    invoke-virtual {p0, v1, v0}, LX/I9I;->A1b(ILjava/lang/Class;)Lcom/facebook/pando/TreeJNI;

    move-result-object v0

    check-cast v0, Lcom/instagram/api/schemas/LocationNoteResponseInfo;
...
.method public final CGw()Lcom/instagram/api/schemas/MusicNoteResponseInfoIntf;
    ...
    iget-object v0, p0, LX/2f4;->A01:Lcom/instagram/api/schemas/MusicNoteResponseInfoIntf;

    if-nez v0, :cond_0

    const v1, 0x32ed0b9

    const-class v0, Lcom/instagram/api/schemas/ImmutablePandoMusicNoteResponseInfo;

    invoke-virtual {p0, v1, v0}, LX/I9I;->A1b(ILjava/lang/Class;)Lcom/facebook/pando/TreeJNI;

    move-result-object v0

    check-cast v0, Lcom/instagram/api/schemas/MusicNoteResponseInfoIntf;
...
.method public final CN6()Lcom/instagram/api/schemas/OriginalAudioNoteResponseInfo;
    ...
    iget-object v0, p0, LX/2f4;->A02:Lcom/instagram/api/schemas/OriginalAudioNoteResponseInfo;

    if-nez v0, :cond_0

    const v1, 0x34bf4216

    const-class v0, Lcom/instagram/api/schemas/ImmutablePandoOriginalAudioNoteResponseInfo;

    invoke-virtual {p0, v1, v0}, LX/I9I;->A1b(ILjava/lang/Class;)Lcom/facebook/pando/TreeJNI;

    move-result-object v0

    check-cast v0, Lcom/instagram/api/schemas/OriginalAudioNoteResponseInfo;
