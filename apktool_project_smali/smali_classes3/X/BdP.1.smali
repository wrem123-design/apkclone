...
# direct methods
.method public static A00(Lcom/instagram/api/schemas/IGTVShare;I)Ljava/lang/Object;
    .locals 0
    ...
    :sswitch_0
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->CAi()I
    ...
    :sswitch_1
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->BOH()I
    ...
    :sswitch_2
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->Dpv()Z
    ...
    :sswitch_3
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->BOO()I
    ...
    :sswitch_4
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->DiW()Z
    ...
    :sswitch_5
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->CC8()Ljava/lang/String;
    ...
    :sswitch_6
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->DE7()Lcom/instagram/user/model/User;
    ...
    :sswitch_7
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->CNR()Ljava/lang/String;
    ...
    :sswitch_8
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->CAF()D
    ...
    :sswitch_9
    invoke-interface {p0}, Lcom/instagram/api/schemas/IGTVShare;->Bqh()Z
    ...
    :sswitch_data_0
    .sparse-switch
        -0x77a61fb8 -> :sswitch_9
        -0x7216ee21 -> :sswitch_8
        -0x6cbe95fc -> :sswitch_7
        0x36ebcb -> :sswitch_6
        0x5d7a3d -> :sswitch_5
        0x7200de6 -> :sswitch_4
        0x2d36b888 -> :sswitch_3
        0x355c87bf -> :sswitch_2
        0x5fd15ea5 -> :sswitch_1
        0x76cfaf8f -> :sswitch_0
    .end sparse-switch
.end method

.method public static A01(LX/2eo;Lcom/instagram/api/schemas/IGTVShare;)Ljava/util/Map;
    .locals 3
