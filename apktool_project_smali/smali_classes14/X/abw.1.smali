...
.field public final synthetic A03:Landroid/view/ViewOutlineProvider;
...
.method public constructor <init>(Landroid/view/ViewOutlineProvider;IIJ)V
    ...
    iput-wide p4, p0, LX/abw;->A02:J

    iput-object p1, p0, LX/abw;->A03:Landroid/view/ViewOutlineProvider;

    iput p2, p0, LX/abw;->A00:I

    iput p3, p0, LX/abw;->A01:I
...
.method public final AFp(LX/02J;Ljava/lang/Object;Ljava/lang/Object;)LX/7eQ;
    ...
    invoke-direct {v0, v5, v1}, LX/8jh;-><init>(Landroid/content/Context;LX/8ie;)V
    ...
    invoke-static {v4, v3}, LX/0Sh;->A01(Landroid/view/View;F)V

    :cond_0
    iget-object v1, p0, LX/abw;->A03:Landroid/view/ViewOutlineProvider;

    const v0, 0xb0b100

    invoke-static {v4, v1, v0}, LX/08R;->A0b(Landroid/view/View;Landroid/view/ViewOutlineProvider;I)V

    iget v2, p0, LX/abw;->A00:I

    invoke-virtual {v4, v2}, Landroid/view/View;->setOutlineAmbientShadowColor(I)V

    iget v1, p0, LX/abw;->A01:I

    invoke-virtual {v4, v1}, Landroid/view/View;->setOutlineSpotShadowColor(I)V

    new-instance v0, LX/llY;

    invoke-direct {v0, v4, v3, v2, v1}, LX/llY;-><init>(Landroid/view/View;FII)V
