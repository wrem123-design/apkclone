...
.field public static volatile sObjectSerializer:LX/0lq;
...
.method public static getFromRawKey(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .catch LX/ACC; {:try_start_0 .. :try_end_0} :catch_5
    ...
    .catch LX/ACC; {:try_start_1 .. :try_end_1} :catch_5
    ...
    .catch LX/ACC; {:try_start_2 .. :try_end_2} :catch_5
    ...
    .catch LX/ACC; {:try_start_3 .. :try_end_3} :catch_5
    ...
    .catch LX/ACC; {:try_start_4 .. :try_end_4} :catch_5
    ...
    .catch LX/ACC; {:try_start_5 .. :try_end_5} :catch_5
    ...
    .catch LX/ACC; {:try_start_6 .. :try_end_6} :catch_5
    ...
    .catch LX/ACC; {:try_start_7 .. :try_end_7} :catch_5
    ...
    .catch LX/ACC; {:try_start_8 .. :try_end_8} :catch_5
    ...
    throw v0
    :try_end_9
    .catch LX/ACC; {:try_start_9 .. :try_end_9} :catch_5
...
.method public static declared-synchronized initialize(Landroid/content/Context;)Z
    ...
    sput-object v0, Lcom/facebook/msys/mci/AuthDataStorage;->sObjectSerializer:LX/0lq;
...
.method public static setWithRawKey(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    if-nez p1, :cond_0
    :try_end_0
    .catch LX/ACC; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .catch LX/ACC; {:try_start_1 .. :try_end_1} :catch_1
    ...
    if-eqz v0, :cond_1
    :try_end_2
    .catch LX/ACC; {:try_start_2 .. :try_end_2} :catch_1
    ...
    .catch LX/ACC; {:try_start_3 .. :try_end_3} :catch_1
    ...
    return-void
    :try_end_4
    .catch LX/ACC; {:try_start_4 .. :try_end_4} :catch_1
    ...
    .catch LX/ACC; {:try_start_5 .. :try_end_5} :catch_1
    ...
    throw v0
    :try_end_6
    .catch LX/ACC; {:try_start_6 .. :try_end_6} :catch_1
