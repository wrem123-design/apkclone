...
.field public final mDisposer:LX/0mM;
...
.method public constructor <init>(Ljava/lang/String;Lcom/facebook/msys/mci/NotificationCenter;LX/CAL;)V
    .locals 2
    ...
    invoke-interface {p3}, LX/CAL;->BVN()Lcom/facebook/msys/mci/DataTaskListener;
    ...
    invoke-direct {v0, p0, p3}, LX/0mM;-><init>(Lcom/facebook/msys/mci/NetworkSession;LX/CAL;)V

    iput-object v0, p0, Lcom/facebook/msys/mci/NetworkSession;->mDisposer:LX/0mM;
    ...
    invoke-interface {p3, v0}, LX/CAL;->GKd(I)V
    :try_end_0
...
.method public executeInNetworkContext(LX/C6Z;)V
    .locals 7
