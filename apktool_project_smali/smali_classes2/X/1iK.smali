...
.method public constructor <init>(Lcom/instagram/common/session/UserSession;LX/8mn;)V
    ...
    iput-object p1, p0, LX/1iK;->A00:Lcom/instagram/common/session/UserSession;

    iput-object p2, p0, LX/1iK;->A01:LX/8mn;
...
.method public final FhG(LX/Lxw;LX/7Kb;Ljava/util/List;Ljava/util/Map;LX/LEN;LX/LEN;Lkotlin/jvm/functions/Function3;Z)LX/9xx;
    ...
    iget-object v1, v2, LX/7Kb;->A00:Ljava/lang/String;
    ...
    iget-object v2, v2, LX/7Kb;->A02:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/1iK;->A00:Lcom/instagram/common/session/UserSession;
    ...
    iget-object v4, v0, LX/3TB;->A0a:LX/8Ot;

    if-eqz v4, :cond_1

    iget-object v3, p0, LX/1iK;->A01:LX/8mn;

    check-cast v3, LX/8qr;

    invoke-virtual {v3, v7}, LX/8qr;->A0L(Lcom/instagram/model/direct/DirectThreadKey;)LX/0uX;
    ...
    :try_start_2
    iput-object v4, v1, LX/0lD;->A0o:LX/8Ot;
    :try_end_2
    ...
    const-string v1, "Invalid instamadilloCutoverMetadata payload"
