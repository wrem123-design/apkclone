...
.field public final A01:LX/KRN;

.field public final A02:LX/83n;


# direct methods
.method public constructor <init>(LX/Qek;LX/KRN;LX/83n;)V
    .locals 1
    ...
    iput-object p3, p0, LX/7lG;->A02:LX/83n;

    iput-object p2, p0, LX/7lG;->A01:LX/KRN;

    iput-object p1, p0, LX/7lG;->A00:LX/Qek;
...
.method public final A0e(LX/6iO;)LX/9ig;
    ...
    iget-object v0, v3, LX/7lG;->A02:LX/83n;
    ...
    iget-object v9, v12, LX/6iO;->A06:LX/2nh;

    iget-object v13, v9, LX/2nh;->A0B:Landroid/content/Context;

    invoke-static {v13}, LX/06B;->A0B(Landroid/content/Context;)I
    ...
    invoke-direct {v2, v3, v0}, LX/304;-><init>(LX/7lG;I)V
    ...
    invoke-direct {v10, v14, v11}, LX/04U;-><init>(LX/04U;LX/04V;)V
    ...
    invoke-static {v13}, LX/06B;->A07(Landroid/content/Context;)I
    ...
    invoke-static {v12}, LX/6vO;->A0E(LX/mzG;)J

    move-result-wide v3

    sget-object v12, LX/7MA;->A04:LX/7MA;
    ...
    invoke-static {v9, v8}, LX/04J;->A02(LX/2nh;I)LX/8vP;

    move-result-object v2

    invoke-virtual {v2, v15}, LX/8vP;->A1V(Ljava/lang/CharSequence;)V

    invoke-virtual {v2, v7}, LX/8vP;->A1S(LX/8jj;)V

    invoke-virtual {v2, v14}, LX/8vP;->A1N(I)V

    iget-object v9, v9, LX/2nh;->A0E:LX/8jh;

    invoke-static {v9, v5, v6}, LX/04Z;->A01(LX/8jh;J)I

    move-result v5

    invoke-virtual {v2, v5}, LX/8vP;->A1O(I)V

    invoke-virtual {v2, v8}, LX/8vP;->A1P(I)V

    invoke-virtual {v2, v13}, LX/8vP;->A1Q(Landroid/graphics/Typeface;)V

    invoke-virtual {v2}, LX/8vP;->A17()V
    ...
    invoke-virtual {v2, v5}, LX/8vP;->A1H(F)V
    ...
    invoke-virtual {v2, v5}, LX/8vP;->A1F(F)V
    ...
    invoke-virtual {v2, v5}, LX/8vP;->A1G(F)V
    ...
    invoke-virtual {v2, v5}, LX/8vP;->A1E(F)V

    invoke-virtual {v2, v12}, LX/8vP;->A1T(LX/7MA;)V

    invoke-virtual {v2, v8}, LX/8vP;->A1J(I)V

    invoke-virtual {v2}, LX/8vP;->A1B()V

    invoke-virtual {v2}, LX/8vP;->A19()V

    invoke-virtual {v2, v8}, LX/8vP;->A1Y(Z)V

    invoke-virtual {v2, v8}, LX/8vP;->A1L(I)V

    const/4 v5, 0x2

    invoke-virtual {v2, v5}, LX/8vP;->A1K(I)V
    ...
    invoke-virtual {v2, v0}, LX/8vP;->A1C(F)V
    ...
    iget-object v1, v2, LX/8vP;->A01:LX/04J;

    iput v0, v1, LX/04J;->A01:F

    invoke-virtual {v2, v8}, LX/8vP;->A1Z(Z)V

    invoke-virtual {v2, v8}, LX/8vP;->A1W(Z)V

    const/4 v0, 0x1

    invoke-virtual {v2, v0}, LX/8vP;->A1X(Z)V

    invoke-virtual {v2, v7}, LX/BWc;->A11(LX/9Az;)V

    iput v10, v1, LX/04J;->A09:I

    invoke-static {v2, v11}, LX/7QA;->A00(LX/BWc;LX/04U;)V
