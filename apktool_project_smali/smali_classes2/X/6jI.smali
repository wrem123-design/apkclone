...
# direct methods
.method public static final A00(LX/TEe;Lcom/instagram/common/session/UserSession;)F
    .locals 1
    ...
    const-wide v0, 0x840ef8001403c1L

    :goto_0
    check-cast p1, Lcom/facebook/mobileconfig/factory/MobileConfigUnsafeContext;

    invoke-interface {p1, v0, p0}, Lcom/facebook/mobileconfig/factory/MobileConfigUnsafeContext;->BZq(J)D
    ...
    :cond_0
    const-wide v0, 0x840ef8001203c0L

    goto :goto_0

    :cond_1
    const-wide v0, 0x840ef8001003beL

    goto :goto_0

    :cond_2
    const-wide v0, 0x840ef8001103bfL

    goto :goto_0

    :cond_3
    const-wide v0, 0x840ef8000303bdL

    goto :goto_0
.end method

.method public static final A01(Lcom/instagram/common/session/UserSession;Lcom/instagram/feed/media/Media;)Ljava/lang/Integer;
    .locals 5
    ...
    const-wide v0, 0x830ef8000e0646L
    ...
    :cond_0
    const-string/jumbo v0, "native_answersheet"

    goto :goto_1

    :cond_1
    const-string/jumbo v0, "native_bottomsheet"
...
.method public static final A02(LX/Ss0;Lcom/instagram/common/session/UserSession;Lcom/instagram/feed/media/Media;)Z
    .locals 1

    invoke-static {p1}, LX/659;->A0u(Ljava/lang/Object;)V

    sget-object v0, LX/Ss0;->A03:LX/Ss0;
...
.method public static final A03(LX/8jV;Lcom/instagram/common/session/UserSession;)Z
    ...
    const-wide v0, 0x810c3000004bdfL
...
.method public static final A04(LX/8jV;Lcom/instagram/common/session/UserSession;)Z
    ...
    invoke-static {p0, p1}, LX/6jI;->A03(LX/8jV;Lcom/instagram/common/session/UserSession;)Z
    ...
    const-wide v0, 0x810c3000044be0L
...
.method public static final A05(Lcom/instagram/common/session/UserSession;)Z
    ...
    const-wide v0, 0x810ef800015986L
...
.method public static final A07(Lcom/instagram/common/session/UserSession;)Z
    ...
    const-wide v0, 0x810ef80013598fL
...
.method public static final A08(Lcom/instagram/common/session/UserSession;)Z
    ...
    const-wide v0, 0x810ef8000b598bL
...
.method public static final A09(Lcom/instagram/common/session/UserSession;)Z
    ...
    const-wide v0, 0x810e7c0001567bL
...
.method public static final A0A(Lcom/instagram/common/session/UserSession;)Z
    ...
    const-wide v0, 0x810ef800155990L
...
.method public static final A0B(Lcom/instagram/common/session/UserSession;Lcom/instagram/feed/media/Media;)Z
    ...
    invoke-static {p1}, LX/6QA;->A02(Lcom/instagram/feed/media/Media;)Z
    ...
    const-wide v0, 0x810c5b00004c62L
...
.method public static final A0C(Lcom/instagram/common/session/UserSession;Lcom/instagram/feed/media/Media;)Z
    ...
    invoke-static {p0, p1}, LX/6jI;->A0B(Lcom/instagram/common/session/UserSession;Lcom/instagram/feed/media/Media;)Z
