...
.method public convert(Lorg/webrtc/VideoFrame$TextureBuffer;)Lorg/webrtc/VideoFrame$I420Buffer;
    ...
    return-object v0
    :try_end_0
    .catch Lorg/webrtc/GlUtil$GlOutOfMemoryException; {:try_start_0 .. :try_end_0} :catch_3
    .catch Landroid/opengl/GLException; {:try_start_0 .. :try_end_0} :catch_2
    ...
    const-string v0, "Generic exception in YuvConverter.convert. Rethrowing"
    ...
    const-string v0, "Java Error in YuvConverter.convert. Rethrowing"
    ...
    const-string v0, "Generic exception in YuvConverter.convert. Failed to convert TextureBuffer"
    ...
    const-string v0, "OOM exception in YuvConverter.convert. Failed to convert TextureBuffer "

    :goto_1
    invoke-static {v2, v0, v1}, Lorg/webrtc/Logging;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
