...
# direct methods
.method public static A00(LX/7UI;I)Ljava/lang/Object;
    .locals 0
    ...
    :sswitch_0
    invoke-interface {p0}, LX/7UI;->D7S()LX/1i9;
    ...
    :sswitch_1
    invoke-interface {p0}, LX/7UI;->CaF()Ljava/lang/String;
    ...
    :sswitch_2
    invoke-interface {p0}, LX/7UI;->BiH()Lcom/instagram/api/schemas/TISUFeatureFlagsMap;
    ...
    :sswitch_3
    invoke-interface {p0}, LX/7UI;->getId()Ljava/lang/String;
    ...
    :sswitch_4
    invoke-interface {p0}, LX/7UI;->CAg()Ljava/util/List;
    ...
    :sswitch_5
    invoke-interface {p0}, LX/7UI;->BS5()LX/Kct;
    ...
    :sswitch_6
    invoke-interface {p0}, LX/7UI;->D7U()Ljava/lang/String;
    ...
    :sswitch_7
    invoke-interface {p0}, LX/7UI;->CIB()Ljava/lang/String;
    ...
    :sswitch_8
    invoke-interface {p0}, LX/7UI;->Bgt()Ljava/util/List;
    ...
    :sswitch_9
    invoke-interface {p0}, LX/7UI;->D9W()Ljava/lang/String;
    ...
    :sswitch_a
    invoke-interface {p0}, LX/7UI;->D0j()Ljava/lang/String;
...
.method public static A01(LX/2eo;LX/7UI;)Ljava/util/Map;
    .locals 5
