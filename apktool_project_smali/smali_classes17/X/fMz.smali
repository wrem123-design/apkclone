...
.method public final A8H(Ljava/util/ListIterator;)V
    ...
    iget-object v0, p0, LX/fMz;->A04:Ljava/util/List;
...
.method public final CPW()Landroid/graphics/Path;
    ...
    iget-object v4, p0, LX/fMz;->A01:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, LX/fMz;->A03:LX/fR1;

    iget-boolean v0, v1, LX/fR1;->A01:Z

    if-nez v0, :cond_b

    iget-object v0, v1, LX/fR1;->A00:Ljava/lang/Integer;
    ...
    :goto_0
    iget-object v7, p0, LX/fMz;->A02:Landroid/graphics/Path;

    invoke-virtual {v7}, Landroid/graphics/Path;->reset()V

    iget-object v6, p0, LX/fMz;->A00:Landroid/graphics/Path;

    invoke-virtual {v6}, Landroid/graphics/Path;->reset()V

    iget-object v10, p0, LX/fMz;->A04:Ljava/util/List;
    ...
    check-cast v12, LX/kyp;

    instance-of v0, v12, LX/OJ6;
    ...
    invoke-virtual {v0}, LX/OJ6;->A00()Ljava/util/List;

    move-result-object v5

    invoke-static {v5, v9}, LX/154;->A04(Ljava/util/List;I)I
    ...
    check-cast v1, LX/OJ6;

    iget-object v0, v1, LX/OJ6;->A00:LX/O8p;
    ...
    :cond_0
    iget-object v0, v1, LX/OJ6;->A02:Landroid/graphics/Matrix;
    ...
    :cond_1
    invoke-interface {v12}, LX/kyp;->CPW()Landroid/graphics/Path;
    ...
    instance-of v0, v3, LX/OJ6;

    if-eqz v0, :cond_8

    check-cast v3, LX/OJ6;

    invoke-virtual {v3}, LX/OJ6;->A00()Ljava/util/List;
    ...
    iget-object v0, v3, LX/OJ6;->A00:LX/O8p;
    ...
    :cond_7
    iget-object v0, v3, LX/OJ6;->A02:Landroid/graphics/Matrix;
    ...
    :cond_8
    invoke-interface {v3}, LX/kyp;->CPW()Landroid/graphics/Path;
    ...
    :cond_9
    iget-object v0, p0, LX/fMz;->A01:Landroid/graphics/Path;
    ...
    :goto_6
    iget-object v2, p0, LX/fMz;->A04:Ljava/util/List;
    ...
    iget-object v1, p0, LX/fMz;->A01:Landroid/graphics/Path;
...
.method public final G2e(Ljava/util/List;Ljava/util/List;)V
    ...
    :goto_0
    iget-object v1, p0, LX/fMz;->A04:Ljava/util/List;
    ...
    invoke-interface {v0, p1, p2}, LX/kPL;->G2e(Ljava/util/List;Ljava/util/List;)V
