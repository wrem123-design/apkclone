...
.method public final GjU(Ljava/lang/Class;)Z
    ...
    iget-object v4, p0, LX/Zha;->A00:[LX/mfd;
    ...
    invoke-interface {v0, p1}, LX/mfd;->GjU(Ljava/lang/Class;)Z
...
.method public final Gjn(Ljava/lang/Class;)LX/loA;
    ...
    invoke-interface {v1, p1}, LX/mfd;->GjU(Ljava/lang/Class;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {v1, p1}, LX/mfd;->Gjn(Ljava/lang/Class;)LX/loA;
