...
.method public static final A00(Lcom/instagram/common/session/UserSession;LX/LEL;Lkotlin/jvm/functions/Function1;)LX/KOv;
    ...
    invoke-static {v12, v2}, LX/132;->A1C(LX/LEN;LX/jAX;)LX/1zi;
    ...
    sget-object v12, LX/IRO;->A00:LX/IRO;

    sget-object v2, Lcom/facebook/pando/PandoRealtimeInfoJNI;->Companion:LX/6of;

    invoke-virtual {v2, v14}, LX/6of;->forLiveQuery(Ljava/lang/String;)Lcom/facebook/pando/PandoRealtimeInfoJNI;
...
.method public static final A01(Lcom/instagram/common/session/UserSession;Lkotlin/jvm/functions/Function1;)V
    ...
    sget-object v8, LX/IRP;->A00:LX/IRP;

    invoke-static {}, LX/011;->A0V()Ljava/util/ArrayList;

    move-result-object v5

    const-string v3, "IGPermissionsFeatureControlQuery"

    const-string v4, "ig_permissions_feature_control"
