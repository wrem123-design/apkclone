...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-static {v5, v4}, Lokhttp3/internal/http2/Http2;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-static {v5, v0}, Lokhttp3/internal/http2/Http2;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    const-string v3, "Expected a SETTINGS frame but was %s"
    ...
    invoke-static {v5, v3, v0, v1, v2}, Lokhttp3/internal/http2/Http2;->frameLog(ZIIBB)Ljava/lang/String;
