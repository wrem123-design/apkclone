...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v1, Landroid/support/design/internal/NavigationMenu;

    invoke-direct {v1, p1}, Landroid/support/design/internal/NavigationMenu;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/design/widget/NavigationView;->mMenu:Landroid/support/design/internal/NavigationMenu;

    sget-object v2, Landroid/support/design/R$styleable;->NavigationView:[I

    sget v3, Landroid/support/design/R$style;->Widget_Design_NavigationView:I
    ...
    sget v3, Landroid/support/design/R$styleable;->NavigationView_android_background:I
    ...
    sget v3, Landroid/support/design/R$styleable;->NavigationView_elevation:I
    ...
    invoke-virtual {v2, v3, v4}, Landroid/support/v7/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    :cond_0
    sget v3, Landroid/support/design/R$styleable;->NavigationView_android_fitsSystemWindows:I

    invoke-virtual {v2, v3, v4}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z

    move-result v3

    invoke-static {p0, v3}, Landroid/support/v4/view/ViewCompat;->setFitsSystemWindows(Landroid/view/View;Z)V

    sget v3, Landroid/support/design/R$styleable;->NavigationView_android_maxWidth:I

    invoke-virtual {v2, v3, v4}, Landroid/support/v7/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Landroid/support/design/widget/NavigationView;->mMaxWidth:I

    sget v3, Landroid/support/design/R$styleable;->NavigationView_itemIconTint:I
    ...
    invoke-direct {p0, v3}, Landroid/support/design/widget/NavigationView;->createDefaultColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v2, v7}, Landroid/support/v7/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-virtual {v2, v7, v4}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    sget v8, Landroid/support/design/R$styleable;->NavigationView_itemTextColor:I

    invoke-virtual {v2, v8}, Landroid/support/v7/widget/TintTypedArray;->hasValue(I)Z
    ...
    invoke-direct {p0, v8}, Landroid/support/design/widget/NavigationView;->createDefaultColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v7

    :cond_4
    sget v8, Landroid/support/design/R$styleable;->NavigationView_itemBackground:I

    invoke-virtual {v2, v8}, Landroid/support/v7/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v9}, Landroid/support/design/internal/NavigationMenu;->setCallback(Landroid/support/v7/view/menu/MenuBuilder$Callback;)V

    const/4 v9, 0x1

    invoke-virtual {v0, v9}, Landroid/support/design/internal/NavigationMenuPresenter;->setId(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemIconTintList(Landroid/content/res/ColorStateList;)V

    if-eqz v5, :cond_5

    invoke-virtual {v0, v6}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemTextAppearance(I)V

    :cond_5
    invoke-virtual {v0, v7}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemTextColor(Landroid/content/res/ColorStateList;)V

    invoke-virtual {v0, v8}, Landroid/support/design/internal/NavigationMenuPresenter;->setItemBackground(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v1, v0}, Landroid/support/design/internal/NavigationMenu;->addMenuPresenter(Landroid/support/v7/view/menu/MenuPresenter;)V
    ...
    invoke-virtual {v2, v0, v4}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
...
.method private createDefaultColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    sget-object v10, Landroid/support/design/widget/NavigationView;->CHECKED_STATE_SET:[I

    aput-object v10, v7, v2

    sget-object v10, Landroid/support/design/widget/NavigationView;->EMPTY_STATE_SET:[I
...
.method protected onMeasure(II)V
    ...
    iget v2, p0, Landroid/support/design/widget/NavigationView;->mMaxWidth:I
