...
.method public constructor <init>(Ljava/lang/Class;ILandroid/support/v7/util/AsyncListUtil$DataCallback;Landroid/support/v7/util/AsyncListUtil$ViewCallback;)V
    ...
    new-instance v2, Landroid/support/v7/util/TileList;

    invoke-direct {v2, p2}, Landroid/support/v7/util/TileList;-><init>(I)V

    iput-object v2, p0, Landroid/support/v7/util/AsyncListUtil;->mTileList:Landroid/support/v7/util/TileList;

    new-instance v2, Landroid/support/v7/util/MessageThreadUtil;

    invoke-direct {v2}, Landroid/support/v7/util/MessageThreadUtil;-><init>()V

    invoke-interface {v2, v0}, Landroid/support/v7/util/ThreadUtil;->getMainThreadProxy(Landroid/support/v7/util/ThreadUtil$MainThreadCallback;)Landroid/support/v7/util/ThreadUtil$MainThreadCallback;
    ...
    invoke-interface {v2, v1}, Landroid/support/v7/util/ThreadUtil;->getBackgroundProxy(Landroid/support/v7/util/ThreadUtil$BackgroundCallback;)Landroid/support/v7/util/ThreadUtil$BackgroundCallback;
