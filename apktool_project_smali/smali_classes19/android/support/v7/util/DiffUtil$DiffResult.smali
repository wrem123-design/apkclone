...
.method private dispatchAdditions(Ljava/util/List;Landroid/support/v7/util/ListUpdateCallback;III)V
    ...
    invoke-direct {v1, v3, p3, v4}, Landroid/support/v7/util/DiffUtil$PostponedUpdate;-><init>(IIZ)V
    ...
    invoke-static {p1, v1, v3}, Landroid/support/v7/util/DiffUtil$DiffResult;->removePostponedUpdate(Ljava/util/List;IZ)Landroid/support/v7/util/DiffUtil$PostponedUpdate;
    ...
    invoke-interface {p2, p3, v3, v5}, Landroid/support/v7/util/ListUpdateCallback;->onChanged(IILjava/lang/Object;)V

    goto :goto_2

    :sswitch_2
    invoke-interface {p2, p3, v3}, Landroid/support/v7/util/ListUpdateCallback;->onInserted(II)V
...
.method private dispatchRemovals(Ljava/util/List;Landroid/support/v7/util/ListUpdateCallback;III)V
    ...
    invoke-direct {v1, v4, v5, v3}, Landroid/support/v7/util/DiffUtil$PostponedUpdate;-><init>(IIZ)V
    ...
    iget v6, v4, Landroid/support/v7/util/DiffUtil$PostponedUpdate;->currentPos:I
    ...
    invoke-interface {p2, v5, v3, v6}, Landroid/support/v7/util/ListUpdateCallback;->onChanged(IILjava/lang/Object;)V
    ...
    invoke-interface {p2, v1, v3}, Landroid/support/v7/util/ListUpdateCallback;->onRemoved(II)V
...
.method public dispatchUpdatesTo(Landroid/support/v7/util/ListUpdateCallback;)V
    ...
    iget-object v2, v8, Landroid/support/v7/util/DiffUtil$DiffResult;->mOldItemStatuses:[I
    ...
    iget v2, v15, Landroid/support/v7/util/DiffUtil$Snake;->x:I

    add-int/2addr v2, v7

    iget-object v3, v8, Landroid/support/v7/util/DiffUtil$DiffResult;->mCallback:Landroid/support/v7/util/DiffUtil$Callback;

    iget v4, v15, Landroid/support/v7/util/DiffUtil$Snake;->x:I

    add-int/2addr v4, v7

    iget v5, v15, Landroid/support/v7/util/DiffUtil$Snake;->y:I

    add-int/2addr v5, v7

    invoke-virtual {v3, v4, v5}, Landroid/support/v7/util/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v3

    const/4 v4, 0x1

    invoke-virtual {v10, v2, v4, v3}, Landroid/support/v7/util/BatchingListUpdateCallback;->onChanged(IILjava/lang/Object;)V
